									...
									<tr>
										<td>
														...
														<tr>
															...
															<td width="20%">
																...
																<input name="text" type="text"  value="${entry.value}"
																	...
																	type="button" value='+' style="width:20px" onclick="changeNum(${entry.key.id},${entry.value+1},${entry.key.pnum})">
																<script type="text/javascript">
																	 ...
																	 * @param snum  库存
																	 */
																	function changeNum(id,num,snum) {
																		//1.购买的数量不能大于库存
																		if (num>snum){
																			alert("购买的数量不能大于库存");
																			return;
																		}
																		//2.如果购买对的数量为0，从购物车移除，给个提示
																		if (num==0){
																			var flag=confirm("您确定要把这件商品从购物车移除？");
																			if (!flag){
																				return;
																			}
																		}
															...
															<td width="10%">${entry.key.price*entry.key.pnum}</td>
															<%--累加总价格--%>
											...
											<div style="text-align:right; margin-top:10px">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;<a
													href="${pageContext.request.contextPath}/CheckAccountServlet"><img
