            ...
            <td style="padding:30px; text-align:center"><table width="60%"
                ...
                <tr>
                    ...
                    <td style="padding-top:30px"><font
                            style="font-weight:bold; color:#FF0000">添加购物车成功,<a href="${pageContext.request.contextPath}/ShowProductByPageServlet">继续购物</a></font><br /> <br />
                        <a href="cart.jsp">查看购物车</a></td>
                </tr>
            </table>
                <h1>&nbsp;</h1></td>
        </tr>
